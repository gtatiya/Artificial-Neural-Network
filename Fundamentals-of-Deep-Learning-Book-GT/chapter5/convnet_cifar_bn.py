    ...
    with tf.device("/gpu:0"):
        ...
        with tf.Graph().as_default():
            ...
            with tf.variable_scope("cifar_conv_bn_model"):
                ...
                #summary_writer = tf.train.SummaryWriter("conv_cifar_bn_logs/", graph_def=sess.graph_def)
                summary_writer = tf.summary.FileWriter("conv_cifar_bn_logs/", graph_def=sess.graph_def)

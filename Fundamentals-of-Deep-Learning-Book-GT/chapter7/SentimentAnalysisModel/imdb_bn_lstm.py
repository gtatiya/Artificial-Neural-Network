...
if __name__ == '__main__':
    ...
    with tf.Graph().as_default():
        with tf.device('/gpu:0'):
            ...
            #summary_writer = tf.train.SummaryWriter("imdb_bnlstm_logs/", graph=sess.graph)
            summary_writer = tf.summary.FileWriter("imdb_bnlstm_logs/", graph_def=sess.graph_def)

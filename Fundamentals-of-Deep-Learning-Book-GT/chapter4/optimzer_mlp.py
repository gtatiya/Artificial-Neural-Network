...
if __name__ == '__main__':
    ...
    with tf.Graph().as_default():
        ...
        with tf.variable_scope("mlp_model"):
            ...
            #summary_writer = tf.train.SummaryWriter("mlp_logs_%s/" % args.optimizer[0], graph_def=sess.graph_def)

            summary_writer = tf.summary.FileWriter("mlp_logs_%s/" % args.optimizer[0], graph_def=sess.graph_def)

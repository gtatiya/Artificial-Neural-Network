...
"""
We also inspect the model regularly using a validation function,
which normalizes the embeddings in the lookup table and uses cosine similarity
to compute distances for a set of validation words from all other words in the vocabulary
"""
...
if __name__ == '__main__':
    ...
    with tf.Graph().as_default():
        ...
        with tf.variable_scope("skipgram_model"):
            ...
            train_writer = tf.summary.FileWriter("skipgram_logs/", graph_def=sess.graph_def)

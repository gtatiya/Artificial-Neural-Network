...
if __name__ == '__main__':
    ...
    """
    We use the commonly used machine learning library scikit-learn to perform the PCA,
    setting the n_components=2 flat so that scikit-learn knows to generate two-dimensional codes
    """
    print("\nSTARTING PCA")
